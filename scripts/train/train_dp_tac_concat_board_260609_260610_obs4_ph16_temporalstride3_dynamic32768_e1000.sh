...
# Board-wiping DP training with temporal stride 3.
# The dataset keeps raw episodes intact, but samples observation/tactile history
# and future action labels every 3 frames to train a faster real-robot policy.
...
SAVE_DIR="/media/chenshuai/SANDISK ELE/tactileact_output/dp_tac_concat_board_260609_260610_left_boardvae_rawimg200x266_ph16_oh4_temporalstride3_dynamic32768_e1000"
...
{
    echo "=== train_dp_tac_concat_board_260609_260610_obs4_ph16_temporalstride3_dynamic32768_e1000 ==="
