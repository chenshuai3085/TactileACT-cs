...
CONFIG=${CONFIG:-TFAC_V5/config_pretrain_foresight_huaping_260630_huapingvae_marker_only_temporalstride2.json}
...
LOG_FILE="${LOG_DIR}/foresight_huaping_temporalstride2_${RUN_ID}.log"

echo "=== train_foresight_huaping_temporalstride2 ==="
