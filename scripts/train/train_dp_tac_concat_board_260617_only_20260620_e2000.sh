...
# DP concat training using only the 2026-06-17 board collection.
# This run is intentionally isolated from earlier 260617-only runs.
...
SAVE_DIR="${SAVE_DIR:-/media/chenshuai/EXTERNAL_USB/pih_output/dp_tac_concat_board_260617_only_left_boardvae_rawimg200x266_ph16_oh2_e2000_20260620_rerun}"
