...
Board scientific priority: `force_aware_foresight_quality_energy` (offline gradient audit ready: `True`, serving smoke ready: `True`, denoising-step smoke ready: `True`, real-window serving ready: `True`, paired rollout manifest ready: `True`).
...
- not_reranking: `True`
- finite_grad_rate / positive_grad_rate / accept_rate: `1.0000` / `1.0000` / `1.0000`
- score_delta_mean: `0.012449`
...
- latest logged epoch/train loss: `698` / `0.003982`
- latest validation epoch/loss: `695` / `0.036859`
- training running at status timestamp: `True` (pid `430211`, status `2026-06-21 22:47:01`)
...
- force_aware_serving_real_window: `/home/chenshuai/Project/output/force_aware_serving_real_window_audit/20260621_191330/force_aware_serving_real_window_audit.json`
