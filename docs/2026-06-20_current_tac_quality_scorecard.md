...
- best val epoch/loss: `35` / `0.018849`
- latest logged epoch/val loss: `37` / `NA`
- training running at status timestamp: `True` (pid `3794700`, status `2026-06-20 12:05:00`)
