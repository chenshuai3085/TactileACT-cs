...
baseline, a reactive diffusion-transformer baseline, and a foresight
...
contact-dropout ratio, retry count, bounce count, and peak force. In this draft,
the completed peg-in-hole insertion benchmark is reported below; the remaining
task-level rollout matrix is still being collected under the same protocol.
